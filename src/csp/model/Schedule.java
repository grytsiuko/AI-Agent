...
public class Schedule {
    ...
    private boolean entitiesTheSameTime(ScheduleEntity entity1, ScheduleEntity entity2) {
        boolean daysEqual = entity1.getScheduleEntityPlaceTime().getStudyDay().equals(entity2.getScheduleEntityPlaceTime().getStudyDay());
        boolean lessonsEqual = entity1.getScheduleEntityPlaceTime().getStudyLesson().equals(entity2.getScheduleEntityPlaceTime().getStudyLesson());
        return daysEqual && lessonsEqual;
    }

    private int calculateErrorRateCorrectClassroom(ScheduleEntity entity) {
        return entity.getScheduleEntityBlock().isLecture() && !entity.getScheduleEntityPlaceTime().getClassroom().isWide()
                ? 1
                : 0;
    }

    private int calculateErrorRateSameClassrooms(ScheduleEntity entity1, ScheduleEntity entity2) {
        Classroom classroom1 = entity1.getScheduleEntityPlaceTime().getClassroom();
        Classroom classroom2 = entity2.getScheduleEntityPlaceTime().getClassroom();
